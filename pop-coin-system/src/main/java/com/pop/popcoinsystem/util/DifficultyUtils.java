...
public class DifficultyUtils {
    ...
    public static void main(String[] args) {
        ...
        int cmpResult2 = compare(difficultyB, difficultyA);
        System.out.println("A 与 B 比较结果: " + cmpResult2); // 输出 -1 (A < B)

        int cmpResult3 = compare(difficultyA, difficultyA);
        System.out.println("A 与 A 比较结果: " + cmpResult3); // 输出 -1 (A < B)
