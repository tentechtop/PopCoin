...
public class NodeInfo implements Comparable<Object>{
    ...
    private NodeNatType nodeNatType;//节点网络类型
    ...
    public NodeInfo(BigInteger id, String ipv4, String ipv6, int udpPort, int tcpPort,boolean isSeedNode) {
        this.id = id;
        this.ipv4 = ipv4;
        this.ipv6 = ipv6;
        ...
        this.nodeType = NodeType.FULL;
        this.nodeNatType = NodeNatType.PUBLIC;
