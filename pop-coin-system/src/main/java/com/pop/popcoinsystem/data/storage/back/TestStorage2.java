...
public class TestStorage2 {
    ...
    private static class InstanceHolder {
        private static final TestStorage2 INSTANCE = new TestStorage2();
    }

    public static TestStorage2 getInstance() {
        return TestStorage2.InstanceHolder.INSTANCE;
    }

    private TestStorage2() {
        try {
