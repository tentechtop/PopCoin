...
public class MiningService {
    ...
    // 难度调整周期的区块数量
    private static final int DIFFICULTY_ADJUSTMENT_INTERVAL = 144;//2016大概两周调整一次  144一天调整一次 2小时
    //区块生成时间
    private static final long BLOCK_GENERATION_TIME = 600; //600是600秒 10分钟
    //货币总供应量
